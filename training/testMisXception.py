...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoints", type=str,
                        default="/home/ubuntu/shahur/Final_Misleading/checkpoints/sam/XceptionMis_Newthird_final/ff++_XceptionMis_Newthird_final3/lamda1_0.1_lamda2_0.01_lr0.001/XceptionMis_Newthird_final0.pth")
    ...
    if opt.model_structure == 'XceptionMis_Newthird_final':
        model_class = DETECTOR['XceptionSRM']
        # print(model_class)

    if opt.model_structure == 'XceptionSRM':
