...
if __name__ == '__main__':
    ...
    parser.add_argument("--savepath", type=str,
                        default='/home/ubuntu/shahur/Misleading/Results/results_newscan1')
    parser.add_argument("--model_structure", type=str, default='XceptionMis_Newmethod_newscam',
    ...
    if opt.model_structure == 'XceptionMis_Newmethod_newscam':
        model_class = DETECTOR['XceptionMis_Newmethod_newscam']
    ...
    for eachatt in interattributes:
        ...
        for i, data_dict in enumerate(test_dataloader):
            ...
            with torch.no_grad():
                ...
                if opt.model_structure == 'ucf_oneStage_fuse04':
