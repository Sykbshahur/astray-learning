...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoints", type=str,
                        default="/home/ubuntu/shahur/Misleading/checkpoints/XceptionMis_Newthird_nofuse_nosa/ff++_XceptionMis_Newthird_nofuse_continue_newStrategy/lamda1_0.1_lamda2_0.01_lr0.001/XceptionMis_Newthird_nofuse_nosa1.pth")
    parser.add_argument("--test_data_name", type=str,
                        default='dfdc')
    parser.add_argument("--model_structure", type=str, default='XceptionMis_Newthird_nofuse_nosa',
    ...
    if opt.model_structure == 'XceptionMis_Newthird_nofuse_nosa':
        model_class = DETECTOR['XceptionMis_Newthird_nofuse_nosa']
        # print(model_class)
